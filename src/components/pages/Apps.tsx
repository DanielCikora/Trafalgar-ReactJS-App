      ...
      <div className='wrapper'>
        <div className='apps-content'>
          <div className='apps-content__image'>
            <a className='apps-image__link' href='/'>
              <img
          ...
          <div className='apps-content__text'>
            ...
            <p className='paragraph apps-text__paragraph'>
              This app is perfect for patients who want to track their diet and
              exercise routines. It allows users to set fitness goals and track
              their progress over time. It also offers a database of food and
              nutrition information, making it easier to stay on top of your
              health and wellness.
            </p>
          </div>
        </div>
